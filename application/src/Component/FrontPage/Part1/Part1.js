                ...
                <div className='part2-container'>
                    <div className='row-2'>
                        ...
                        <div className='part-right-2'>
                            ...
                            {/* <img  src={logo2} alt="asd" classNameName="part1-image d-lg-block d-none"/> */}
                        </div>
                    </div>
                ...
                <div className='content'>
                    <div className='insurancePlanCard_content'>
                        ...
                        <div className="insurancePlanCards__content__container">
                            <a className="insurancePlanCards__content__container__item icon-7" href="">
                            ...
                            <a className="insurancePlanCards__content__container__item icon-8" href="">
